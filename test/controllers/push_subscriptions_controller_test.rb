...
class PushSubscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create push_subscription" do
    assert_difference("PushSubscription.count") do
      post push_subscriptions_url, params: { push_subscription: { auth: @push_subscription.auth, endpoint: @push_subscription.endpoint, p256dh: @push_subscription.p256dh, subscribed: @push_subscription.subscribed } }
    end
  ...
  test "should update push_subscription" do
    patch push_subscription_url(@push_subscription), params: { push_subscription: { auth: @push_subscription.auth, endpoint: @push_subscription.endpoint, p256dh: @push_subscription.p256dh, subscribed: @push_subscription.subscribed } }
